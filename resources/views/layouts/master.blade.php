...
<html lang="en">
  ...
  <body>
    {{-- Jika berada di home, gunakan class layout-home, jika tidak, gunakan layout-default biasa --}}
    <div class="flex flex-col @if(Route::getCurrentRoute()->uri() == '/') layout-home @else layout-default @endif">
